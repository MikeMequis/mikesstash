...
Claro, nem tudo por aqui envolve código. Gosto de **desenhar**, **jogar**, **descobrir** coisas novas e **registrar** algumas dessas experiências. O próprio *Mike's Stash* nasceu dessa vontade de reunir tudo isso em um lugar que tivesse mais a minha cara do que um simples perfil ou portfólio.
...
Want to know more about the person behind the site? You're in the right place.
...
Of course, not everything here is about code. I also enjoy **drawing**, playing **games**, **discovering** new things, and **documenting** some of those experiences. *Mike's Stash* itself came from the desire to bring all of that together in a place that felt more like me than a simple profile or portfolio.
