...
O próximo desenho tem uma história interessante por trás.

No anterior, você pode notar **traços rígidos e grossos**.

Isso dá um aspecto legal e coerente com a **poesia** que escrevi pois estava me sentindo inspirado de repente?

Sim.

... Mas **não foi proposital**.

Lembra que comentei sobre **perfeccionismo mais atrapalhar do que ajudar** algumas páginas anteriores? Pois é. Desde o primeiro desenho, eu tinha um hábito que consumia **muito** do meu tempo de desenvolvimento. O motivo era simples: **ainda não separava o desenho em etapas**.

A sequência de elaboração de um desenho, em termos simples, seria em forma de fases sequenciais:

```
Formas geométricas & Esboço -> Retoques e ajustes -> Finalização.
```

A minha sequência era essa:
