...
- ✅ SDK limpo para desenvolvedores de mods
- ✅ Registro de logs abrangente em `Asher/AsherLogs/`
...
- ✅ Criação de atalho na área de trabalho após a instalação

### Mods Funcionais
- ✅ **Debug Menu Enabler** — `Tab` no menu de pausa abre o menu de depuração
- ✅ **Intro Skipper** — Pula a classificação ESRB, telas de splash e vídeos de inicialização
